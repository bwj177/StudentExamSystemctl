...
public class ManageStudentFrm extends JInternalFrame {
	...
	public ManageStudentFrm() {
		...
		label.setIcon(new ImageIcon(ManageStudentFrm.class.getResource("/images/学生管理2.png")));
		...
		label_2.setIcon(new ImageIcon(ManageStudentFrm.class.getResource("/images/学生管理2.png")));
		...
		label_5.setIcon(new ImageIcon(ManageStudentFrm.class.getResource("/images/密码1.png")));
