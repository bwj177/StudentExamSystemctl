...
//	}
	...
	public EditPasswordFrm() {
		...
		label.setIcon(new ImageIcon(EditPasswordFrm.class.getResource("/images/密码1.png")));
		...
		label_1.setIcon(new ImageIcon(EditPasswordFrm.class.getResource("/images/修改密码2.png")));
		...
		label_2.setIcon(new ImageIcon(EditPasswordFrm.class.getResource("/images/修改密码2.png")));
		...
		label_3.setIcon(new ImageIcon(EditPasswordFrm.class.getResource("/images/用户名1q.png")));
