...
public class AddStudentFrm extends JInternalFrame {
	...
	public AddStudentFrm() {
		...
		label.setIcon(new ImageIcon(AddStudentFrm.class.getResource("/images/Ñ§Éú¹ÜÀí2.png")));
		...
		label_2.setIcon(new ImageIcon(AddStudentFrm.class.getResource("/images/ÃÜÂë1.png")));
