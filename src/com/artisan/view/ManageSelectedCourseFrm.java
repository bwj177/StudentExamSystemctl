...
public class ManageSelectedCourseFrm extends JInternalFrame {
	...
	public ManageSelectedCourseFrm() {
		...
		label.setIcon(new ImageIcon(ManageSelectedCourseFrm.class.getResource("/images/学生管理2.png")));
		...
		label_2.setIcon(new ImageIcon(ManageSelectedCourseFrm.class.getResource("/images/学生管理2.png")));
