...
public class ManageCourseFrm extends JInternalFrame {
	...
	public ManageCourseFrm() {
		...
		label.setIcon(new ImageIcon(ManageCourseFrm.class.getResource("/images/课程2.png")));
		...
		label_2.setIcon(new ImageIcon(ManageCourseFrm.class.getResource("/images/课程2.png")));
